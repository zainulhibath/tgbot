...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "928406379:AAF8zPqOyRRlAITbt4Tm2xADQHra5h6XO1c"
    OWNER_ID = "843714186"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "Zainstech"
